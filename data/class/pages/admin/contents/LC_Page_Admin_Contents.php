...
class LC_Page_Admin_Contents extends LC_Page_Admin_Ex
{
    ...
    public function lfInitParam(&$objFormParam)
    {
        ...
        $objFormParam->addParam('日付(年)', 'year1', INT_LEN, 'n', array('EXIST_CHECK', 'NUM_CHECK', 'MAX_LENGTH_CHECK'));
        $objFormParam->addParam('日付(月)', 'month1', INT_LEN, 'n', array('EXIST_CHECK', 'NUM_CHECK', 'MAX_LENGTH_CHECK'));
        $objFormParam->addParam('日付(日)', 'day1', INT_LEN, 'n', array('EXIST_CHECK', 'NUM_CHECK', 'MAX_LENGTH_CHECK'));
